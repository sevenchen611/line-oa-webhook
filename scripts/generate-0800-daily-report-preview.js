...
<head>
  ...
  <title>SevenAM 08:00 日報 - ${escapeHtml(data.today)}</title>
  <style>
...
<body>
  <div class="app">
    <aside>
      <div class="brand"><strong>SevenAM<br>08:00 日報</strong><span>由 SevenAM Notion 資料庫產生<br>${escapeHtml(data.today)} 08:00</span></div>
    ...
    <main>
      <div class="top">
        <div><h1>早上 8 點總控日報</h1><div class="sub">這份是用 SevenAM 專案的 Notion 資料庫產生的本機預覽，不會寫回 Notion，也不會送 LINE。</div></div>
      ...
      <section id="summary"><div class="section-head"><h2>今日開局摘要</h2><span>先定方向，再處理候選項</span></div><div class="summary-grid">
        ...
        <article class="summary-card"><h3>待負責人口述</h3><p>目前有 ${data.goalGapTasks.length} 筆任務缺少明確完成目標，08:00 適合先要求負責人口述。</p></article>
