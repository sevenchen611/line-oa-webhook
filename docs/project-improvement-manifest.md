...
| --- | --- | --- | --- | --- | --- |
| `AM-IMP-2026.0608.01` | Project data isolation guard | Installed | 2026-06-08 | Commit `Install shared AM improvements for SevenAM`; `docs/upgrades/UPGRADE-2026-06-08-AM-IMP-2026.0608.01.md` | `node --check` passed; local health passed; daily preview read SevenAM Notion data without sending LINE. Production deploy pending verification. |
| `AM-IMP-2026.0608.02` | Scheduled report multi-recipient rule | Installed | 2026-06-08 | Commit `Install shared AM improvements for SevenAM`; `docs/upgrades/UPGRADE-2026-06-08-AM-IMP-2026.0608.02.md` | `node --check` passed; local health showed `multiRecipientReportEnabled=true`; no-send daily preview passed. Production deploy pending verification. |
| `AM-IMP-2026.0608.03` | LINE task-query reply command | Installed | 2026-06-08 | Commit `Install shared AM improvements for SevenAM`; `docs/upgrades/UPGRADE-2026-06-08-AM-IMP-2026.0608.03.md` | `node --check` passed; local health showed `taskQueryReplyEnabled=true`; safe production LINE command test pending after deploy. |
